...
**Date:** 2025-12-07T16:28:12.712987
**Status:** PASS
...
| Fields Found | 165 |
| Fields Tested | 165 |
| Edge Cases Target | 6105 |
| Edge Cases Run | 6105 |
| **Pass Rate** | **100.0%** |

## Target vs Actual

- Target: 165 fields x 37 edge cases = 6105
- Actual: 6105
- Gap: 0
...
### /staff/login #changePasswordForm
Edge cases: 148
...
| Field | Tag/Type | Edge Cases |
|-------|----------|------------|
| first_name | input/text | PASS 37/37 |
| last_name | input/text | PASS 37/37 |
| email | input/email | PASS 37/37 |
| password | input/password | PASS 37/37 |
