...
**Date:** 2025-12-07T16:52:55.502322
...
| /staff/login | unnamed | ElementHandle.inner_text: Execution cont |
| /staff/login | unnamed | ElementHandle.inner_text: Execution cont |
| /staff/login | unnamed | ElementHandle.inner_text: Execution cont |
| /staff/login | unnamed | ElementHandle.inner_text: Execution cont |
| /staff/login | unnamed | ElementHandle.inner_text: Execution cont |
...
| /dashboard/settlements | unnamed | ElementHandle.inner_text: Execution cont |
| /dashboard/settlements | unnamed | ElementHandle.inner_text: Execution cont |
| /dashboard/staff | unnamed | ElementHandle.inner_text: Execution cont |
| /dashboard/staff | unnamed | ElementHandle.inner_text: Execution cont |
| /dashboard/staff | unnamed | ElementHandle.inner_text: Execution cont |
| /dashboard/staff | unnamed | ElementHandle.inner_text: Execution cont |
| /dashboard/staff | unnamed | ElementHandle.inner_text: Execution cont |
...
| /dashboard/sol | unnamed | ElementHandle.inner_text: Execution cont |
| /dashboard/sol | unnamed | ElementHandle.inner_text: Execution cont |
| /dashboard/predictive | unnamed | ElementHandle.inner_text: Execution cont |
| /dashboard/predictive | unnamed | ElementHandle.inner_text: Execution cont |
| /dashboard/predictive | unnamed | ElementHandle.inner_text: Execution cont |
...
| # | Button | Status | Notes |
|---|--------|--------|-------|
| 0 | 📞 Contacted | WORKING | Has onclick: markContacted('client' |
| 1 | 📞 Contact | WORKING | Has onclick: markContacted('client' |
| 2 | 📞 Contact | WORKING | Has onclick: markContacted('client' |
| 3 | 📞 Contact | WORKING | Has onclick: markContacted('client' |
| 4 | 📞 Contact | WORKING | Has onclick: markContacted('client' |
| 5 | 📞 Contact | WORKING | Has onclick: markContacted('client' |
| 6 | 📞 Contact | WORKING | Has onclick: markContacted('client' |
| 7 | 📞 Contact | WORKING | Has onclick: markContacted('client' |
| 8 | 📞 Contact | WORKING | Has onclick: markContacted('client' |
| 9 | 📞 Contact | WORKING | Has onclick: markContacted('client' |
| 10 | 📞 Contact | WORKING | Has onclick: markContacted('client' |
| 11 | 📞 Contact | WORKING | Has onclick: markContacted('client' |
...
| # | Button | Status | Notes |
|---|--------|--------|-------|
| 0 | Add Staff Member | WORKING | Opens modal |
| 1 | Edit | NOT_BUILT | Click timeout - may not be wired up |
| 2 | unnamed | BROKEN | ElementHandle.inner_text: Execution |
| 3 | unnamed | BROKEN | ElementHandle.inner_text: Execution |
| 4 | unnamed | BROKEN | ElementHandle.inner_text: Execution |
| 5 | unnamed | BROKEN | ElementHandle.inner_text: Execution |
...
| 3 | Dismiss Letter | HIDDEN | Button not visible on page (likely  |
...
| # | Button | Status | Notes |
|---|--------|--------|-------|
| 0 | Check Deadlines | WORKING | Has onclick: checkDeadlines() |
| 1 | unnamed | BROKEN | ElementHandle.inner_text: Execution |
| 2 | unnamed | BROKEN | ElementHandle.inner_text: Execution |
| 3 | unnamed | BROKEN | ElementHandle.inner_text: Execution |
| 4 | unnamed | BROKEN | ElementHandle.inner_text: Execution |
...
| # | Button | Status | Notes |
|---|--------|--------|-------|
| 0 | Refresh Forecasts | WORKING | Has onclick: refreshData() |
| 1 | unnamed | BROKEN | ElementHandle.inner_text: Execution |
| 2 | unnamed | BROKEN | ElementHandle.inner_text: Execution |
| 3 | unnamed | BROKEN | ElementHandle.inner_text: Execution |
...
| # | Button | Status | Notes |
|---|--------|--------|-------|
| 0 | 📤 Send Test | DISABLED | Button is disabled |
...
- **Total Buttons Found:** 453
- **Total Buttons Tested:** 453
- **Working:** 81 (17.9%)
- **Need Building:** 15
- **Need Fixing:** 245
- **Hidden (in modals):** 109
- **Disabled:** 3
