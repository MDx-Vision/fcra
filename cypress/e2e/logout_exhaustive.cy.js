...
describe('/portal/logout - Client Login Page', () => {
  ...
  describe('Login Form Tests', () => {
    it('should display login form with all required fields', () => {
      ...
      cy.get('[data-testid="portal-password-input"]').should('be.visible').should('have.attr', 'required');
    });
  ...
  describe('Forgot Password Form Tests', () => {
    ...
    it('should display forgot password form elements', () => {
      ...
      cy.get('[data-testid="forgot-email-input"]').should('be.visible').should('have.attr', 'required');
  ...
  describe('Reset Password Form Tests', () => {
    ...
    it('should display reset password form elements', () => {
      ...
      cy.get('[data-testid="new-password-input"]').should('be.visible').should('have.attr', 'required');
      cy.get('[data-testid="confirm-password-input"]').should('be.visible').should('have.attr', 'required');
