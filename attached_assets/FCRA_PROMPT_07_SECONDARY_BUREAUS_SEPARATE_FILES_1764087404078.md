# FCRA PROMPT 07: SECONDARY BUREAUS — FREEZE + FILE (SEPARATE FILES)
## Upload → Analyze → Generate 9 Separate Files
...
---------------------------------------------------------------------------
DEMAND #1: SECURITY FREEZE — FCRA § 1681c-1
---------------------------------------------------------------------------
...
---------------------------------------------------------------------------
DEMAND #2: FULL FILE DISCLOSURE — FCRA § 1681g
---------------------------------------------------------------------------
...
**FREE disclosure per FCRA § 1681j.**
...
5. Once received → Use Prompt 08 to dispute errors
