# FCRA PROMPT 09: BIG 3 CRA — PII CORRECTION (SEPARATE FILES)
## Upload → Analyze → Confirm → Generate 3 Separate Files
...
**STEP 1:** Analyze report → Show PII table → Ask confirmation
**STEP 2:** After confirmation → Generate 3 separate files
...
Previous Addresses:
- [Address 1] — KEEP or DELETE?
- [Address 2] — KEEP or DELETE?

Employers:
- [Employer 1] — KEEP or DELETE?
...
**FCRA §§ 1681e(b), 1681i — INACCURATE PII VIOLATES FEDERAL LAW**
═══════════════════════════════════════════════════════════════════════
...
PERSONAL IDENTIFYING INFORMATION** in violation of FCRA § 1681e(b).

**This is not a request. This is a DEMAND backed by federal law.**

---------------------------------------------------------------------------
SECTION 1: INACCURATE PII IN YOUR FILE — DELETE THESE
---------------------------------------------------------------------------
...
**INCORRECT ADDRESSES:**
✗ [Wrong address 1] — DELETE
✗ [Wrong address 2] — DELETE

**INCORRECT PHONE NUMBERS:**
✗ [Wrong phone 1] — DELETE

**INCORRECT EMPLOYERS:**
✗ [Wrong employer 1] — DELETE

---------------------------------------------------------------------------
SECTION 2: CORRECT INFORMATION — KEEP ONLY THESE
---------------------------------------------------------------------------

**NAME:** ✓ [Full Legal Name] — DELETE ALL OTHERS

**ADDRESS:** ✓ [Current Address] — DELETE ALL OTHERS
[If user approved previous addresses, list them]

**SSN:** ✓ [XXX-XX-XXXX] — DELETE ALL VARIATIONS

**DOB:** ✓ [MM/DD/YYYY]

**PHONE:** ✓ [Phone or NONE] — DELETE ALL OTHERS

**EMPLOYER:** ✓ [Employer or NONE] — DELETE ALL OTHERS

---------------------------------------------------------------------------
SECTION 3: WHY THIS MATTERS — LEGAL VIOLATIONS
---------------------------------------------------------------------------

Inaccurate PII violates FCRA § 1681e(b) and causes direct harm:
...
**EVERY DAY you maintain inaccurate PII = continuing § 1681e(b) violation.**
