...
from database import get_db, Client, ClientNote
                ...
                for row_num, row in enumerate(reader, start=2):  # Start at 2 (header is row 1)
                    ...
                    try:
                        ...
                        client = Client(
                            ...
                            credit_monitoring_password=row.get('cr_password', '').strip() or None,
    ...
    def validate_csv(csv_path: str) -> Dict[str, Any]:
        ...
        try:
            with open(csv_path, 'r', encoding='utf-8-sig') as f:
                ...
                missing = [f for f in required_fields if f not in validation['available_fields']]
                ...
                validation['valid'] = validation['has_required_fields'] and validation['row_count'] > 0
