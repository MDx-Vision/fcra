    ...
    def add_header_footer(self, canvas, doc):
        ...
        if os.path.exists(self.logo_path):
            try:
                ...
                canvas.setFillColor(BRIGHTPATH_TEAL)
                canvas.drawString(
                    doc.leftMargin, self.page_height - 35, "Brightpath Ascend Group"
                )
        else:
            canvas.setFont("Helvetica-Bold", 14)
            canvas.setFillColor(BRIGHTPATH_TEAL)
        ...
        canvas.drawRightString(
            self.page_width - doc.rightMargin, 22, f"Page {doc.page}"
        )
...
class LetterPDFGenerator:
    ...
    def generate_dispute_letter_pdf(
        self, letter_content, client_name, bureau, round_number, output_path
    ):
        """
        ...
        if branded_template:
            doc.build(
                story,
                onFirstPage=branded_template.add_header_footer,
        ...
        for letter in letters_data:
            try:
                ...
                generated_files.append(
                    {"success": True, "filepath": filepath, "bureau": letter["bureau"]}
                )
...
class CreditAnalysisPDFGenerator:
    ...
    def generate_credit_analysis_pdf(
        self, client_name, report_date, credit_scores, negative_items, output_path
    ):
        """
        ...
        story.append(
            Paragraph(
                f"Dear {client_name.split()[0] if ' ' in client_name else client_name},",
                body_style,
            )
        )
        story.append(Spacer(1, 0.2 * inch))
        story.append(
            Paragraph(
                ...
                "you as a potential new client! We would be thrilled to have you with us.",
                body_style,
            )
        )
        story.append(
            Paragraph(
                ...
                "tirelessly to ensure we can help you achieve your financial goals.",
                body_style,
            )
        )
        story.append(
            Paragraph(
                ...
                "improve your credit. It also includes a simple step-by-step plan to speed up the process.",
                body_style,
            )
        )
        story.append(Spacer(1, 0.3 * inch))
        story.append(
            Paragraph(
                "This credit analysis report is broken down into the following five sections:",
                body_style,
            )
        )
        story.append(Spacer(1, 0.1 * inch))
        ...
        story.append(
            Paragraph(
                ...
                "score. So, having a high credit score will save you many thousands of dollars.",
                body_style,
            )
        )

        story.append(
            Paragraph("Credit Score Ranges And Their Meaning", subheading_style)
        )
        ranges = [
            (
            ...
            (
                "700 - 799 (Very Good)",
                "27% of the United States population belongs to this range. You will enjoy good rates.",
            ),
            (
                "680 - 699 (Good)",
                "This is the average credit score range. Approvals are practically guaranteed.",
            ),
            (
                "620 - 679 (OK or Fair)",
                "You might find that quoted rates aren't the best, but you can still get approved.",
            ),
            (
                "580 - 619 (Poor)",
                "You can still get loans, but terms and interest rates won't be appealing.",
            ),
            (
                "500 - 579 (Bad)",
                "Getting a loan is difficult. Rates will be very high and terms very strict.",
            ),
            (
                "499 and Lower (Very Bad)",
                "You need serious assistance handling your credit.",
            ),
        ]
        ...
        story.append(
            Paragraph("PART 2 - WHAT'S INCLUDED IN YOUR CREDIT REPORT", heading_style)
        )

        sections_content = [
            (
                "Personal Data",
                "Your current and previous addresses, employers, full name variations, social security number, and date of birth. Keeping this information accurate helps avoid credit profile mergers with others.",
            ),
            (
                "Public Records",
                "Judgments, bankruptcies, foreclosures, evictions - these are credit report killers. They cause the worst damage and weigh heavily on your scores.",
            ),
            (
                "Inquiries",
                "Each time your credit is 'hard-pulled' by a potential creditor, it costs you score points. Soft pulls do not affect your score.",
            ),
            (
                "Accounts and Tradelines",
                "All revolving and installment accounts including credit cards, mortgages, auto loans, student loans, and personal loans.",
            ),
            (
                "Collection Accounts",
                "Unpaid charged-off accounts sold to collection agencies. We do NOT advise paying these without verification of accuracy and a written deletion agreement.",
            ),
            (
                "Credit Utilization",
                "As a rule of thumb, keep your balances at 30% or less of available credit to maximize your score.",
            ),
        ]
        ...
        story.append(
            Paragraph(
                ...
                "impacting your credit scores and need to be addressed.",
                body_style,
            )
        )
        story.append(Spacer(1, 0.2 * inch))
        ...
        if negative_items:
            ...
            story.append(
                Paragraph(
                    "No negative items found on your credit report at this time.",
                    body_style,
                )
            )
        ...
        process_steps = [
            (
                "Step 1: Analysis",
                "We thoroughly analyze your credit reports from all three bureaus to identify disputable items.",
            ),
            (
                "Step 2: Strategy",
                "We develop a customized dispute strategy based on your specific situation and goals.",
            ),
            (
                "Step 3: Disputes",
                "We prepare and send professionally written dispute letters to the credit bureaus.",
            ),
            (
                "Step 4: Monitoring",
                "We track bureau responses and monitor your credit for changes.",
            ),
            (
                "Step 5: Escalation",
                "If necessary, we escalate disputes using Method of Verification (MOV) requests and pre-litigation tactics.",
            ),
        ]
