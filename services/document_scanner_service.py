...
from database import get_db, Client, Document
...
class DocumentScanner:
    ...
    def __init__(self):
        self.client = None
        try:
            api_key = os.environ.get('FCRA Automation Secure') or os.environ.get('ANTHROPIC_API_KEY')
            if api_key:
    ...
    def extract_text_from_image(
        ...
        try:
            ...
            return {
                ...
                'estimated_cost': round((input_tokens * 0.003 + output_tokens * 0.015) / 1000, 4)
            }
...
class ScanSession:
    ...
    def __init__(self, client_id: int = None, client_name: str = None, document_type: str = 'credit_report'):
...
def create_scan_session(client_id: int = None, client_name: str = None, document_type: str = 'credit_report') -> Dict:
