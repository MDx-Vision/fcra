...
class StripeWebhooksService:
    ...
    def _handle_payment_succeeded(self, event: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if payment_type == 'analysis':
            ...
            # Log timeline event
            self._log_timeline(client.id, 'payment_received', 'Analysis Payment Received',
            ...
            if round_number == 1 and client.client_stage in ['pending_payment', 'onboarding']:
            ...
            # Log timeline event
            self._log_timeline(client.id, 'payment_received', f'Round {round_number} Payment',
            ...
            self._log_timeline(client.id, 'payment_received', 'Prepay Package Purchased',
    ...
    def _handle_refund(self, event: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Log timeline event
        self._log_timeline(client.id, 'refund_processed', 'Refund Processed',
    ...
    def _log_timeline(self, client_id: int, event_type: str, title: str, description: str):
