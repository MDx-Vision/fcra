...
from database import Case, Client, Violation, get_db
...
def generate_debt_validation_letter(client, collection_info):
    ...
    client_city_state_zip = (
        f"{pii['address_city']}, {pii['address_state']} {pii['address_zip']}"
    )
    ...
    creditor_city_state_zip = collection_info.get(
        "creditor_city_state_zip", "[CITY, STATE ZIP]"
    )
...
def _add_validation_letter_to_pdf(pdf, letter_content):
    ...
    if letter_content.get("reference_number"):
        pdf.cell(
            0,
            6,
            f"RE: Account Reference #{letter_content['reference_number']}",
            ln=True,
        )
    ...
    pdf.cell(
        0,
        6,
        f"Alleged Original Creditor: {letter_content['original_creditor']}",
        ln=True,
    )
    ...
    pdf.cell(
        0, 8, "NOTICE OF DISPUTE AND DEMAND FOR DEBT VALIDATION", ln=True, align="C"
    )
...
def _create_validation_letter_docx(letter_content):
    ...
    content_items.append(
        {
            "type": "paragraph",
            "text": letter_content["client_name"],
            "bold": False,
            "size": 11,
        }
    )
    content_items.append(
        {
            "type": "paragraph",
            "text": letter_content["client_address"],
            "bold": False,
            "size": 11,
        }
    )
    content_items.append(
        {
            "type": "paragraph",
            "text": letter_content["client_city_state_zip"],
            "bold": False,
            "size": 11,
        }
    )
    ...
    content_items.append(
        {"type": "paragraph", "text": letter_content["date"], "bold": False, "size": 11}
    )
    content_items.append({"type": "spacing"})
    ...
    content_items.append(
        {
            "type": "paragraph",
            "text": letter_content["creditor_name"],
            "bold": True,
            "size": 11,
        }
    )
    content_items.append(
        {
            "type": "paragraph",
            "text": letter_content["creditor_address"],
            "bold": False,
            "size": 11,
        }
    )
    content_items.append(
        {
            "type": "paragraph",
            "text": letter_content["creditor_city_state_zip"],
            "bold": False,
            "size": 11,
        }
    )
    ...
    if letter_content.get("reference_number"):
        content_items.append(
            {
                "type": "paragraph",
                "text": f"RE: Account Reference #{letter_content['reference_number']}",
                "bold": False,
                "size": 11,
            }
        )
    content_items.append(
        {
            "type": "paragraph",
            "text": f"RE: Alleged Account #{letter_content['account_number']}",
            "bold": False,
            "size": 11,
        }
    )
    content_items.append(
        {
            "type": "paragraph",
            "text": f"Alleged Original Creditor: {letter_content['original_creditor']}",
            "bold": False,
            "size": 11,
        }
    )
    content_items.append(
        {
            "type": "paragraph",
            "text": f"Alleged Balance: {letter_content['balance']}",
            "bold": False,
            "size": 11,
        }
    )
    ...
    content_items.append(
        {
            "type": "paragraph",
            "text": "NOTICE OF DISPUTE AND DEMAND FOR DEBT VALIDATION",
            "bold": True,
            "size": 12,
            "center": True,
        }
    ...
    content_items.append(
        {
            "type": "paragraph",
            "text": "PURSUANT TO 15 U.S.C. 1692g (FDCPA)",
            "bold": True,
            "size": 12,
            "center": True,
        }
    ...
    content_items.append(
        {"type": "paragraph", "text": dispute_text, "bold": False, "size": 11}
    )
    content_items.append({"type": "spacing"})
    ...
    content_items.append(
        {"type": "paragraph", "text": cease_text, "bold": False, "size": 11}
    )
    content_items.append({"type": "spacing"})
    ...
    content_items.append(
        {
            "type": "paragraph",
            "text": "REQUIRED DOCUMENTATION FOR PROPER VALIDATION:",
            "bold": True,
            "size": 11,
        }
    )
    ...
    for item in validation_items:
        content_items.append(
            {"type": "paragraph", "text": item, "bold": False, "size": 11}
        )

    content_items.append({"type": "spacing"})

    content_items.append(
        {"type": "paragraph", "text": "ADDITIONAL DEMANDS:", "bold": True, "size": 11}
    )
    demands = [
        "- CEASE all telephone calls to me, my family, and my place of employment",
        "- DO NOT report this disputed debt to any credit reporting agency",
    ...
    for demand in demands:
        content_items.append(
            {"type": "paragraph", "text": demand, "bold": False, "size": 11}
        )

    content_items.append({"type": "spacing"})

    content_items.append(
        {"type": "paragraph", "text": "LEGAL NOTICE:", "bold": True, "size": 11}
    )
    legal_notice = (
        "Be advised that I am aware of my rights under the Fair Debt Collection Practices Act (FDCPA), "
        "the Fair Credit Reporting Act (FCRA), and applicable state laws. Any violation of these laws "
    ...
    content_items.append(
        {"type": "paragraph", "text": legal_notice, "bold": False, "size": 11}
    )
    content_items.append({"type": "spacing"})
    ...
    content_items.append(
        {"type": "paragraph", "text": response_text, "bold": False, "size": 11}
    )
    content_items.append({"type": "spacing"})
    ...
    content_items.append(
        {
            "type": "paragraph",
            "text": "Govern yourself accordingly.",
            "bold": False,
            "size": 11,
        }
    )
    content_items.append({"type": "spacing"})
    content_items.append(
        {"type": "paragraph", "text": "Sincerely,", "bold": False, "size": 11}
    )
    content_items.append({"type": "spacing"})
    content_items.append({"type": "spacing"})
    content_items.append(
        {"type": "paragraph", "text": "_" * 40, "bold": False, "size": 11}
    )
    content_items.append(
        {
            "type": "paragraph",
    ...
    content_items.append(
        {
            "type": "paragraph",
            "text": "CC: Consumer Financial Protection Bureau",
            "bold": False,
            "size": 9,
            "italic": True,
        }
    ...
    content_items.append(
        {
            "type": "paragraph",
            "text": "    State Attorney General Office",
            "bold": False,
            "size": 9,
            "italic": True,
        }
...
def generate_validation_letters(client_id, collections=None, case_id=None):
    ...
    try:
        ...
        if collections is None and case_id:
            ...
            if case:
                violations = (
                    db.query(Violation).filter(Violation.case_id == case_id).all()
                )
                ...
                for v in violations:
                    if v.creditor_name and v.creditor_name not in seen_accounts:
                        if any(
                            kw in (v.violation_type or "").lower()
                            for kw in ["collection", "debt", "charged"]
                        ):
                            collections.append(
                                {
        ...
        client_name_safe = "".join(
            c for c in (client.name or "client") if c.isalnum() or c in " _-"
        ).replace(" ", "_")
        ...
        for i, letter_content in enumerate(letter_contents):
            ...
            _add_validation_letter_to_docx(
                doc, letter_content, add_page_break=not is_last
            )
